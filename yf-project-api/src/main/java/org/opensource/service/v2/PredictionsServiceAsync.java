...
public class PredictionsServiceAsync extends YahooServiceAsync<YahooAnalystData> implements IYahooEndpointServiceAsyncExecutable {

  public PredictionsServiceAsync() {
    super();
  }

  public PredictionsServiceAsync(org.opensource.model.web.YahooSession session) {
    super(session);
  }

  @Override
  public CompletableFuture<YahooAnalystData> executeAsync(String ticker) throws YahooServiceException {
    try {
      ...
      return session.crumbAsync().thenCompose((String crumb) -> {
        ...
        return getResultAsync(request, YahooAnalystData.class);
      ...
      CompletableFuture<YahooAnalystData> failedFuture = new CompletableFuture<>();
