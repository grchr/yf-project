...
public class CompanyProfileServiceAsync extends YahooServiceAsync<YahooCompanyProfile> implements IYahooEndpointServiceAsyncExecutable {

  public CompanyProfileServiceAsync() {
    super();
  }

  public CompanyProfileServiceAsync(org.opensource.model.web.YahooSession session) {
    super(session);
  }

  @Override
  public CompletableFuture<YahooCompanyProfile> executeAsync(String ticker) throws YahooServiceException {
    try {
      ...
      return session.crumbAsync().thenCompose((String crumb) -> {
        ...
        return getResultAsync(request, YahooCompanyProfile.class);
      ...
      CompletableFuture<YahooCompanyProfile> failedFuture = new CompletableFuture<>();
